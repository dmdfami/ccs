  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        rotationDashboard: 'Rotation Dashboard',
      },
      home: {
        profiles: 'Profiles',
        cliproxy: 'CLIProxy',
      ...
      auth: {
        ...
        googleLoginDescription: 'Sign in with your Google account to access the dashboard.',
        signInWithGoogle: 'Sign in with Google',
        googleWhitelistTitle: 'Google account required',
        googleWhitelistDescription: 'Only whitelisted Google accounts can access this dashboard.',
        oauthErrorAccessDenied: 'Google sign-in was cancelled or access was denied.',
        oauthErrorEmailNotAllowed:
          'Your Google account email is not on the allowed list. Contact the administrator.',
        oauthErrorFailed: 'Google sign-in failed. Please try again.',
      },
      commonToast: {
      ...
      rotationDashboard: {
        ...
        subtitle: 'Live account rotation status and strategy configuration',
        lastUpdated: 'Updated at',
        refresh: 'Refresh',
        strategy: 'Strategy',
        strategyUpdated: 'Rotation strategy updated',
        ...
        statusBanned: 'Banned',
        cooldownUntil: 'Resumes in',
        active: 'active',
        cooldown: 'cooldown',
        rpm: 'RPM',
        noAccounts: 'No accounts found',
        noAccountsHint: 'CLIProxy may not be running or has no credentials configured.',
        errorLoading: 'Failed to load rotation status',
      },
    },
  },
  'zh-CN': {
    translation: {
      ...
      auth: {
        ...
        showPassword: '显示密码',
        hidePassword: '隐藏密码',
        googleLoginDescription: '使用您的 Google 账号登录以访问控制台。',
        signInWithGoogle: '使用 Google 登录',
        googleWhitelistTitle: '需要 Google 账号',
        googleWhitelistDescription: '只有白名单中的 Google 账号才能访问此控制台。',
        oauthErrorAccessDenied: 'Google 登录已取消或访问被拒绝。',
        oauthErrorEmailNotAllowed: '您的 Google 账号邮箱不在允许列表中，请联系管理员。',
        oauthErrorFailed: 'Google 登录失败，请重试。',
      },
      commonToast: {
      ...
      rotationDashboard: {
        title: '轮转仪表板',
        subtitle: '实时账号轮转状态与策略配置',
        lastUpdated: '更新时间',
        refresh: '刷新',
        strategy: '策略',
        strategyUpdated: '轮转策略已更新',
        ...
        rpm: 'RPM',
        noAccounts: '未找到账号',
        noAccountsHint: 'CLIProxy 可能未运行或未配置凭据。',
        errorLoading: '加载轮转状态失败',
      },
    },
  },
  vi: {
    translation: {
      ...
      nav: {
        ...
        rotationDashboard: 'Bảng xoay vòng',
      },
      home: {
        profiles: 'Hồ sơ',
        cliproxy: 'CLIProxy',
      ...
      auth: {
        ...
        googleLoginDescription: 'Đăng nhập bằng tài khoản Google để truy cập bảng điều khiển.',
        signInWithGoogle: 'Đăng nhập bằng Google',
        googleWhitelistTitle: 'Yêu cầu tài khoản Google',
        googleWhitelistDescription:
          'Chỉ những tài khoản Google trong danh sách cho phép mới có thể truy cập bảng điều khiển này.',
        oauthErrorAccessDenied: 'Đăng nhập Google đã bị hủy hoặc quyền truy cập bị từ chối.',
        oauthErrorEmailNotAllowed:
          'Email tài khoản Google của bạn không có trong danh sách cho phép. Hãy liên hệ quản trị viên.',
        oauthErrorFailed: 'Đăng nhập Google thất bại. Vui lòng thử lại.',
      },
      commonToast: {
      ...
      rotationDashboard: {
        title: 'Bảng xoay vòng tài khoản',
        subtitle: 'Trạng thái xoay vòng và cấu hình chiến lược theo thời gian thực',
        lastUpdated: 'Cập nhật lúc',
        refresh: 'Làm mới',
        strategy: 'Chiến lược',
        strategyUpdated: 'Đã cập nhật chiến lược xoay vòng',
        strategyRoundRobin: 'Vòng tròn',
        strategyFillFirst: 'Lấp đầy trước',
        ...
        noAccountsHint: 'CLIProxy có thể chưa chạy hoặc chưa cấu hình thông tin đăng nhập.',
        errorLoading: 'Không thể tải trạng thái xoay vòng',
      },
    },
  },
  ja: {
    translation: {
      ...
      nav: {
        ...
        rotationDashboard: 'ローテーションダッシュボード',
      },
      home: {
        profiles: 'プロファイル',
        cliproxy: 'CLIProxy',
      ...
      auth: {
        ...
        googleLoginDescription:
          'Google アカウントでサインインしてダッシュボードにアクセスしてください。',
        signInWithGoogle: 'Google でサインイン',
        googleWhitelistTitle: 'Google アカウントが必要です',
        googleWhitelistDescription:
          'ホワイトリストに登録された Google アカウントのみがこのダッシュボードにアクセスできます。',
        oauthErrorAccessDenied: 'Google サインインがキャンセルされたか、アクセスが拒否されました。',
        oauthErrorEmailNotAllowed:
          'あなたの Google アカウントのメールアドレスは許可リストに含まれていません。管理者にお問い合わせください。',
        oauthErrorFailed: 'Google サインインに失敗しました。もう一度お試しください。',
      },
      commonToast: {
      ...
      rotationDashboard: {
        title: 'ローテーションダッシュボード',
        subtitle: 'リアルタイムのアカウントローテーション状態と戦略設定',
        lastUpdated: '更新時刻',
        refresh: '更新',
        strategy: '戦略',
        strategyUpdated: 'ローテーション戦略が更新されました',
        strategyRoundRobin: 'ラウンドロビン',
        strategyFillFirst: '優先充填',
        ...
        noAccountsHint:
          'CLIProxy が実行されていないか、認証情報が設定されていない可能性があります。',
        errorLoading: 'ローテーション状態の読み込みに失敗しました',
      },
    },
  },
} as const;
